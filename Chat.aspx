...
<head runat="server">
    ...
    <link href="Content/bootstrap_rtl.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        function registerEvents(chatHub) {
            ...
            if (name.length > 0) {
                chatHub.server.connect(name,<% = Session["USERID"].ToString() %>);
        ...
        function AddUser(chatHub, id, name, UserImage, date) {
            ...
            if (userId == id) {
                ...
                code = $('<div class="box-comment">' +
                    '<img class="img-circle img-sm" src="' + UserImage + '" alt="User Image" style="float:right;" />' +
                    ' <div class="comment-text">' +
                    '<span class="username" style="float:right; padding:4px 10px 0 0;">'
                    + name + '<span class="text-muted pull-right" style="padding-right: 96px;">' + date + '</span>  </span></div></div>');
                ...
                code = $('<div class="box-comment" id="Div' + id + '">' +
                    '<img class="img-circle img-sm" src="' + UserImage + '" alt="User Image" style="float:right;" />' +
                    ' <div class="comment-text">' +
                    '<span class="username" style="float:right; padding:4px 10px 0 0;">' + '<a id="' + id + '" class="user" >' + name + '<a>' + '<span class="text-muted pull-right" style="padding-right: 96px;">' + date + '</span>  </span></div></div>');
...
<body>
    <form id="form1" runat="server">
        ...
        <a href="index2.html" class="logo">
          ...
          <img src="images/NewLogo.png" style="width:30%"/>
        </a>
        <!-- Header Navbar: style can be found in header.less -->
        <nav class="navbar navbar-static-top" role="navigation" <%--style="background-color: #407d35;"--%>>
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary direct-chat direct-chat-primary">
                       <div class="box-header with-border">
                            <h3 class="box-title" style="color:dimgrey; padding: 0 44%;">مرحبا بك   <%--<span id='spanUser'></span>--%></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
