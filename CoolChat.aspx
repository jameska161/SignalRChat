<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoolChat.aspx.cs" Inherits="SignalRChat.CoolChat" %>
...
<div id="frame">
	<div id="sidepanel">
		<div id="profile">
			<div class="wrap">
				<img id="profile-img" src="<%= UserImage %>" class="online" alt="" />
				<p><%= this.UserName %></p>
	...
	<div class="content">
		...
		<div class="message-input">
			<div class="wrap">
			<input type="text" id="txtMessage" placeholder="Write your message..." />
			<i class="fa fa-paperclip attachment" aria-hidden="true"></i>
			<button id="btnSendMsg" class="submit"><i class="fa fa-paper-plane" aria-hidden="true"></i></button>
			</div>
		</div>
	</div>
</div>
...
function registerEvents(chatHub) {
    ...
    $('#btnSendMsg').click(function () {
        ...
        function AddMessage(userName, message, time, userimg) {
                ...
                $('<li class="'+ Side +'"><img src="'+ userimg +'" alt="" /><p>' + message +
